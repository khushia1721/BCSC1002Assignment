...
public class FrontDesk {
    ...
    public static void main(String[] args) {
        ...
        library.setBooksThatAreCurrentlyAvailable();
        String bookName;
        do {
            ...
            switch (studentChoice) {
                case ISSUE_A_NEW_BOOK:
                    ...
                    student.setFirstNameOfTheStudent(scanner.nextLine());
                    student.setMiddleNameOfTheStudent(scanner.nextLine());
                    student.setLastNameOfTheStudent(scanner.nextLine());
                    ...
                    for (int bookIssuingIndex = 0; bookIssuingIndex <
                            student.getNumberOfBooksIssuedByStudent(); bookIssuingIndex++) {
                        System.out.println("Enter name of book " + (bookIssuingIndex + 1) + ": ");
                        bookName = scanner.nextLine();
                        student.getNamesOfBooksIssuedByStudent();
                    }
